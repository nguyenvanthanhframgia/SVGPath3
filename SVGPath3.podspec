#
# Be sure to run `pod lib lint SVGPath3.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  s.name             = 'SVGPath3'
  s.version          = '0.1.0'
  s.summary          = 'A short description of SVGPath3.'
...
TODO: Add long description of the pod here.
  ...
  s.source_files = 'SVGPath3/Classes/**/*'
  
  # s.resource_bundles = {
  #   'SVGPath3' => ['SVGPath3/Assets/*.png']
  # }
